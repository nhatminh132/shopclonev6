<?php
    ...
    queryCancelInvoices();
    curl_get(base_url('cron/cron1.php?pin='.$CMSNT->site('pin_cron')));
    ...
    if ($CMSNT->site('type_bank') == 'TPBank') {
        $result = curl_get("https://api.sieuthicode.net/historyapitpb/$token");
        $result = json_decode($result, true);
    ...
    curl_get(base_url('cron/cron.php?pin='.$CMSNT->site('pin_cron')));